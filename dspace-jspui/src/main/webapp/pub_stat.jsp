...
<%
    ...
    final int octoberViews = -1;
    final int octoberDownloads = -1;

//    final int novemberViews = 158322;
//    final int novemberDownloads = 343209;
//
...
//    final int decemberDownloads = -1;
    ...
    stats = String.format(stats, sd.getTotalCount(), totalViews, totalDownloads,
            totalViews - year2011Views - year2012Views - year2013Views - janViews - febViews - marViews - aprViews - mayViews - juneViews - julyViews - augustViews - septemberViews, // current month views
            totalViews - year2011Views - year2012Views - year2013Views, // current year views
            totalDownloads - year2011Downloads  - year2012Downloads - year2013Downloads - janDownloads - febDownloads - marDownloads - aprDownloads - mayDownloads - juneDownloads - julyDownloads - augustDownloads - septemberDownloads, // current month downloads
