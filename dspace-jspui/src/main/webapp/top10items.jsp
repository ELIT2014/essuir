...
<table align="center" width="95%" border="0">
		            <tr>
		            	<th></th>
		            	<th><fmt:message key="org.dspace.app.webui.jsptag.ItemTag.downloads"/></th>
		            </tr>
		            <tr>
...
<%
		...
		try {
		    ...
		    try {
		        ...
		        ResultSet res = s.executeQuery("SELECT metadatavalue.item_id, metadata_field_id, text_value, downloads" +
											    "	FROM metadatavalue" +
											    "	RIGHT JOIN (" +
											    ...
											    "	WHERE metadata_field_id IN (25, 64)" +
											    "	ORDER BY downloads DESC, item_id, metadata_field_id");
		        int item_id;
		        long downloads;
		        String url;
		        String title;
