 ...
 * Time: 6:04 PM
 */
public class FilemapsGenerator extends SitemapsOrgGenerator {

    public FilemapsGenerator(File outputDirIn, String urlStem, String urlTail) {
        super(outputDirIn, urlStem, urlTail);
    }

    public String getFilename(int number) {
        return "filemap" + number + ".xml.gz";
    }

    public String getIndexFilename()
    {
        return "filemap_index.xml.gz";
    }
